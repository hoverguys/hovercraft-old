...
// Calculate w (xy[1] * z[1] - xy[0] * z[0]) and store it in W
...
// Calculate x (xy[0] * z[0] + xy[1] * z[1]) and store it in X
	ps_mul fr7, fr4, fr3       // fr7 = xy * z
	ps_sum0 fr7, fr7, fr7, fr7 // fr7 = (fr7[0] + fr7[1], fr7[1])
	psq_st fr7, 0(r6), 1, 0    // out.x = fr7[0]
// Calculate y (xz[0] * y[0] + xz[1] * y[1]) and store it in Y
	ps_mul fr7, fr6, fr2       // fr7 = xz * y
	ps_sum0 fr7, fr7, fr7, fr7 // fr7 = (fr7[0] + fr7[1], fr7[1])
	psq_st fr7, 4(r6), 1, 0    // out.y = fr7[0]
// Calculate z (yz[0] * x[0] - yz[1] * x[1]) and store it in Z
